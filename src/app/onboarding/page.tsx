...
export default async function OnboardingPage() {
  ...
  return (
    <main className="min-h-dvh bg-slate-950 px-5 py-8 text-zinc-100">
      <div className="mx-auto max-w-2xl">
        <p className="text-sm text-cyan-200">가벼운 온보딩</p>
        <h1 className="mt-2 text-3xl font-semibold">처음부터 긴 프로필은 필요 없어요.</h1>

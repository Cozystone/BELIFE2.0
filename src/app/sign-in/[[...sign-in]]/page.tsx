    ...
    return (
      <main className="flex min-h-dvh items-center justify-center bg-slate-950 p-5 text-zinc-100">
        <section className="w-full max-w-md rounded-md border border-white/[0.08] bg-white/[0.04] p-6">
          <h1 className="text-2xl font-semibold">BELIFE 로그인</h1>
          <p className="mt-3 text-sm leading-6 text-zinc-500">
            Clerk가 연결되지 않은 환경에서는 BELIFE 네이티브 인증이 Neon 위에서 동작합니다.
          </p>
          <div className="mt-6">
          ...
          <p className="mt-5 text-center text-sm text-zinc-500">
            계정이 없나요?{" "}
            <Link href="/sign-up" className="text-cyan-200 hover:text-cyan-100">
              만들기
            </Link>
          </p>

...
- State Dynamics Lens through `GET /api/state/dynamics` for personal state-coupling hypotheses
- Safety Boundary through `GET /api/safety` for non-clinical crisis-signal checks and support resources
